...
## Environments
- Preview: https://main--cbalanescu-2-wknd-trendsetters--aemdemos.aem.page/
- Live: https://main--cbalanescu-2-wknd-trendsetters--aemdemos.aem.live/
...
1. Open the `cbalanescu-2-wknd-trendsetters` directory in your favorite IDE and start coding :)
